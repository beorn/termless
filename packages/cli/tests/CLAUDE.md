...
bun vitest run vendor/beorn-termless/packages/cli/tests/cli.test.ts   # Session manager
bun vitest run vendor/beorn-termless/packages/cli/tests/record.test.ts # Frame recording + slideshow
```
