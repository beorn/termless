...
```bash
bun vitest run vendor/termless/packages/vt100/tests/              # All vt100 tests
bun vitest run vendor/termless/packages/vt100/tests/ -t "color"   # Color-related tests
bun vitest run vendor/termless/packages/vt100/tests/ -t "encode"  # Key encoding tests
```
